...
#Create a pipeline.
pipeline = Pipeline([("scaler", StandardScaler()), ("model", DecisionTreeRegressor(max_depth = _, min_samples_split = _, min_samples_leaf = _, max_leaf_nodes = _, max_features = _, random_state = 42))])
'''
IMPORTANT
Hyperparameters:
