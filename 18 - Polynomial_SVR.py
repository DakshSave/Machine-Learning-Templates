...
#Create a pipeline.
pipeline = Pipeline([("scaler", StandardScaler()), ("model", SVR(kernel = "poly", degree = _, C = _))]) #Replace the underscores with the degree of the polynomial / value of the regularization parameter (C).
