...
#Create a pipeline.
pipeline = Pipeline([("scaler", StandardScaler()), ("model", XGBClassifier(n_estimators = _, learning_rate = _, max_depth = _, use_label_encoder=False, eval_metric='logloss', random_state=42))]) #Replace the underscores with number of estimators, learning_rate, and max_depth.
