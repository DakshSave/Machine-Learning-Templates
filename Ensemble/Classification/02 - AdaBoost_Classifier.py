...
#Create a pipeline.
pipeline = Pipeline([("scaler", StandardScaler()), ("model", AdaBoostClassifier(n_estimators = _, learning_rate = _, random_state = 42))]) 
#Replace the underscores with number of estimators (n_estimators) and learning_rate.
