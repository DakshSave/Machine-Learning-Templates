...
#Create a pipeline.
pipeline = Pipeline([("scaler", StandardScaler()), ("model", GradientBoostingRegressor(n_estimators = _, learning_rate = _, max_depth = _, random_state = 42))]) #Replace the underscores with number of estimators, learning_rate, and max_depth.
