...
#Create a pipeline.
pipeline = Pipeline([("scaler", StandardScaler()), ("model", SVC(kernel = "rbf", gamma = _, C = _))]) #Replace the underscores with the value of gamma (influence of each training data point) / value of the regularization parameter (C).
